...
Great Docs also accepts the equivalent Sphinx/RST forms:
...
Both syntaxes produce the same callouts. Use Sphinx syntax when the same docstrings must work with
both Great Docs and Sphinx; otherwise, prefer Great Docs `%` directives.
