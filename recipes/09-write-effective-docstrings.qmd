...
Some patterns render poorly. Keep summary lines short enough for the sidebar. Use
reStructuredText field lists and roles, such as `:param:` and
`` :py:exc:`ValueError` ``, only with `parser: sphinx`. RST callouts such as
`.. note::` work with every parser. Document every parameter if you document any
of them.
